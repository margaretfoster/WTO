...
out05 <- callWS(corpus.subset=tst.05,
                fixed.point1="India",
                fixed.point2="European Union")

pdf(file="wordscoresM05eu.pdf")
