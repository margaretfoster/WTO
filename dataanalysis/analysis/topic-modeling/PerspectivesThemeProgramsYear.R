...
############################
## Identify how factions talk about programs
############################
...
prep.out10.themefaction <- estimateEffect(c(1:10) ~s(year)+ faction,
                                          mod.out10.themefaction,
                                          metadata=out$meta,
                                          documents=out$documents,
                                          uncertainty=c("Global"))
...
mod.out10.themecat <- stm(documents=out$documents,
                        vocab=out$vocab,
                        data=out$meta,
                        K=10, ## 
                        prevalence=category.model,
...
prep.out10.themecat <- estimateEffect(c(1:10) ~s(year)+ cat,
                         mod.out10.themecat,
                          metadata=out$meta,
                          documents=out$documents,
                          uncertainty=c("Global"))
...
save.image(file="ProgramsSubSetstmYear.Rdata")
