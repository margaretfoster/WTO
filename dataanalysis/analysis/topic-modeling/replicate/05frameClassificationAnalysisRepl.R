...
write.csv(tst.out, "wto-hand-classRepl.csv")
...
pdf(file="ROCPlot-delegatelistsRepl.png")
autoplot(hand.roc) +
...
roc.all.mods <- rbind(
    cbind(svm.roc, Model="SVM"),
    cbind(nb.roc, Model="NB"),
    cbind(glm.roc, Model="GLM"),
    cbind(rf.roc, Model="RF"),
    cbind(hand.roc, Model="Delegate"))
...
ggsave(gg, file="classificationAllModsRepl.png")
