...
## This specification: Model covariates by meeting number
...
prep.2 <- estimateEffect(c(1:2) ~s(meetingno),
                         mod.out.2,
                          metadata=out$meta,
...
save.image(file="twoTopicsAndSubSets-NoAdminSubset_Alt.Rdata")
